...
function CreatePublikasiPost() {
  ...
  const handleImportMetadata = (metadata: MarkdownImportMetadata) => {
    ...
    if (metadata.coverImage && !coverImage.trim()) {
    ...
    try {
      ...
      const message =
        error && typeof error === 'object' && 'response' in error
          ...
          : undefined
      toast.error(message || 'Gagal menyimpan publikasi')
    } finally {
              ...
              <div className="flex items-center gap-4">
                ...
                <div className="space-y-1">
                  ...
                  <p className="text-xs text-slate-400">
                    Jika diaktifkan, postingan ini hanya dapat dilihat oleh user yang sudah login.
                  </p>
                </div>
              </div>
