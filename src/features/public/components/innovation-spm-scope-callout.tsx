...
export function InnovationSpmScopeCallout() {
    return (
        <LegalCallout variant='important'>
            <strong>Cakupan capaian SPM:</strong> modul operasional, API publik, dan peta landing pada
            dokumen ini mencakup <strong>SPM bidang air minum</strong> (unit SPAM, SR, KK, jiwa
