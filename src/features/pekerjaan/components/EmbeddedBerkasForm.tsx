...
import { createBerkas } from '@/features/berkas/api';
...
export default function EmbeddedBerkasForm({ pekerjaanId, onSuccess }: EmbeddedBerkasFormProps) {
        ...
        <Card>
            ...
            <CardContent>
                <form onSubmit={handleSubmit} className="space-y-4">
                    ...
                    <div className="space-y-2">
                        <Label htmlFor="embedded-berkas-file">File Dokumen <span className="text-red-500">*</span></Label>
                    ...
                    <div className="pt-4 flex justify-end">
                        <Button type="submit" disabled={loading}>
                            ...
                            {loading ? 'Menyimpan...' : 'Upload Berkas'}
                        </Button>
                    </div>
                </form>
            </CardContent>
