...
export const getPekerjaan = async (params?: { page?: number; kecamatan_id?: number; desa_id?: number; kegiatan_id?: number }) => {
    ...
    const response = await apiClient.get<PekerjaanResponse>(url, { params: { page: params?.page } });
