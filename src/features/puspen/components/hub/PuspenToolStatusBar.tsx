...
export function PuspenToolStatusBar({
    ...
    return (
        <header className="flex flex-wrap items-center justify-between gap-3 border-b-[3px] border-[#111111] bg-[#1A1A2E] px-4 py-3 text-[#FFF7E8] sm:px-6">
            <div className="flex flex-wrap items-center gap-3">
                {showHubBack ? (
                    ...
                    >
                        ...
                        <span className={puspenLabel}>Hub</span>
                    </Link>
                ) : null}
                ...
                <div className={`hidden bg-[#FFF7E8] px-3 py-1.5 text-[#111111] sm:inline-flex ${puspenBorder} ${puspenShadowSm}`}>
                    <span className="text-xs font-black uppercase tracking-[0.14em]">{toolName}</span>
                </div>
            </div>
            ...
            <div className="flex flex-wrap items-center gap-3">
                ...
                {showDashboardExit ? (
                    ...
                    >
                        ...
                        <span className={puspenLabel}>Exit</span>
                    </Link>
                ) : null}
            </div>
        </header>
