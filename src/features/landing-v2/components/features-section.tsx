...
function SecurityVisual() {
  return (
    <svg viewBox="0 0 200 160" className="w-full h-full">
      ...
      {/* Keyhole */}
      <circle cx="100" cy="80" r="4" fill="var(--primary-foreground)" />
      <rect x="98" y="82" width="4" height="8" fill="var(--primary-foreground)" />
...
function WaterVisual() {
  return (
    <svg viewBox="0 0 240 180" className="w-full h-full" role="img" aria-label="Ilustrasi air minum dan sanitasi">
      ...
      <path d="M20 146h200" stroke="currentColor" strokeOpacity="0.18" />
      <path d="M28 146c18-17 35-17 53 0 18-17 35-17 53 0 18-17 35-17 53 0" fill="none" stroke="currentColor" strokeWidth="2" opacity="0.55">
        <animate attributeName="stroke-dashoffset" from="0" to="-28" dur="2.5s" repeatCount="indefinite" />
      </path>
      <path d="M48 72h62v74H48z" fill="url(#waterFill)" stroke="currentColor" strokeWidth="2" />
      <path d="M44 72h70" stroke="currentColor" strokeWidth="3" />
      <path d="M58 63c0-12 8-19 21-19h9c8 0 13 4 16 10" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" />
      <path d="M78 91v35" stroke="currentColor" strokeWidth="2" opacity="0.35" />
      <path d="M69 109h18M69 119h18" stroke="currentColor" strokeWidth="2" opacity="0.35" />
      <path d="M141 92c0-17 13-30 30-30s30 13 30 30v54h-60z" fill="none" stroke="currentColor" strokeWidth="2" />
      <path d="M134 92h74" stroke="currentColor" strokeWidth="3" />
      <path d="M156 77h30M156 87h30" stroke="currentColor" strokeWidth="2" opacity="0.35" />
      <circle cx="171" cy="119" r="7" fill="currentColor" opacity="0.12" stroke="currentColor" strokeWidth="2" />
      <path d="M171 115v8M167 119h8" stroke="currentColor" strokeWidth="2" strokeLinecap="round" />
      {[0, 1, 2].map((i) => (
        <path key={i} d="M128 31c0 7-6 11-6 17 0 6 5 10 11 10s11-4 11-10c0-6-6-10-6-17" fill="none" stroke="currentColor" strokeWidth="2" opacity="0.7">
          <animateTransform attributeName="transform" type="translate" values={`0 ${i * 5};0 ${i * 5 - 8};0 ${i * 5}`} dur="2s" begin={`${i * 0.35}s`} repeatCount="indefinite" />
        </path>
      ))}
    </svg>
  );
